...
const Payment = () => {
  ...
  const handlePayment = async () => {
    try {
      ...
      if (!loaded) {
        alert("Payment gateway failed to initialize. Please check your connection.");
        setLoading(false);
        return;
      }
      ...
      const options = {
        ...
        handler: async function (response) {
          try {
            ...
            console.error(error);
            alert("Order compilation failed, please contact customer support.");
          }
        },
        prefill: {
          name: "Customer",
        ...
        theme: {
          color: "#f97316", // Custom brand color match (Orange-500)
        },
      };
      ...
      console.error(error);
      alert("An unexpected error occurred during checkout setup.");
    } finally {
      setLoading(false);
    }
  };
          ...
          <div className="lg:col-span-2 space-y-4">
            <div className="bg-white border border-slate-200 rounded-xl p-5 sm:p-6 shadow-sm space-y-5">
              ...
              <div className="flex items-center gap-3 pb-3.5 border-b border-slate-100">
                ...
                <div>
                  <h2 className="text-sm font-bold text-slate-800">Available Gateways</h2>
                  <p className="text-[11px] text-slate-400 font-medium">Choose your payment mode wrapper below</p>
                </div>
              </div>
            ...
            <div className="bg-white border border-slate-200 rounded-xl p-5 sm:p-6 shadow-sm space-y-5">
              ...
              <div className="space-y-3.5 text-xs font-medium text-slate-500">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-slate-800 font-semibold">₹{amount.toLocaleString("en-IN")}</span>
                </div>
                ...
                <div className="flex justify-between items-baseline pt-1">
                  <span className="text-slate-800 font-bold text-sm">Amount Payable</span>
              ...
              >
                {loading ? (
                  <span className="font-bold animate-pulse">Initializing Gateway...</span>
                ) : (
                  <>
